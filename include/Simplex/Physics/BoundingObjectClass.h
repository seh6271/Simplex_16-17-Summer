...
namespace Simplex {
	//System Class
	class SimplexDLL BoundingObjectClass
	{
	...
	public:
		...
		*/
		...
		ARGUMENTS:
		- int a_nRenderOption = BTO_DISPLAY::BD_NONE \ Options BD_BS | BD_OB | BD_AB
		OUTPUT: ---
		*/
		void SetVisible(int a_nRenderOption = BTO_DISPLAY::BD_NONE);
		/*
		...
		*/
		...
		ARGUMENTS:
		- a_v3Color -> determinate the color of the box to be rendered, if DEFAULT_V3NEG
		...
		*/
		...
		ARGUMENTS:
		- vector3 a_v3Color = DEFAULT_V3NEG -> Color of the Object to display if the value is DEFAULT_V3NEG it
		-- will display Objects in white and colliding ones in red.
		OUTPUT: ---
		*/
		void AddBOToRenderList(vector3 a_v3Color = DEFAULT_V3NEG);
		/*
		...
		OUTPUT: ---
		*/
		void AddOBToRenderList(vector3 a_v3Color = DEFAULT_V3NEG);
		/*
		...
		OUTPUT: ---
		*/
		void AddABToRenderList(vector3 a_v3Color = DEFAULT_V3NEG);
...
//EXPIMP_TEMPLATE template class SimplexDLL std::vector<BoundingObjectClass>;
//EXPIMP_TEMPLATE template class SimplexDLL std::vector<BoundingObjectClass*>;
