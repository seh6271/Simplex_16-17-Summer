...
#include "Simplex\Mesh\MeshManagerSingleton.h"
namespace Simplex
{

//System Class
class SimplexDLL BOManagerSingleton
{
...
public:
	...
	*/
	...
	- vector3 a_v3Color = DEFAULT_V3NEG -> color to render
	OUTPUT: ---
	*/
	void SetVisible(uint a_nIndex, int a_nRenderOptions = BD_NONE, vector3 a_v3Color = DEFAULT_V3NEG);
