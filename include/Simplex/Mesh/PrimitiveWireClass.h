...
class SimplexDLL PrimitiveWireClass : public MeshClass
{
...
public:
	...
	*/
	...
	OUTPUT: ---
	*/
	void GenerateLine(vector3 a_v3StartColor = C_WHITE, vector3 a_v3EndColor = C_WHITE);
...
EXPIMP_TEMPLATE template class SimplexDLL std::vector<PrimitiveWireClass>;
EXPIMP_TEMPLATE template class SimplexDLL std::vector<PrimitiveWireClass*>;
