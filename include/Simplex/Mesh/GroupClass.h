...
public:
	...
	*/
	...
	- vector3 a_v3Tint = DEFAULT_V3NEG -> tint of the group
	OUTPUT: ---
	*/
	...
	*/
	...
	OUTPUT: ---
	*/
	void SetVisibleBO(int a_nOption = BTO_DISPLAY::BD_NONE);
...
EXPIMP_TEMPLATE template class SimplexDLL std::vector<GroupClass>;
EXPIMP_TEMPLATE template class SimplexDLL std::vector<GroupClass*>;
