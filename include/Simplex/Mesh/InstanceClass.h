...
#include "Simplex\Mesh\ModelClass.h"
#include "Simplex\Mesh\PrimitiveManagerSingleton.h"

namespace Simplex
{

class SimplexDLL InstanceClass
{
	bool m_binstantiated = false;	//OUT_DONE instantiated flag
	...
	Sequence* m_pSequence = nullptr; //Sequence played outside of state
...
public:
	...
	*/
	...
	OUTPUT: ---
	*/
	void SetShaderProgram(String a_sVertexShaderName, String a_sFragmentShaderName, String a_sShaderName, vector3 a_v3Tint = DEFAULT_V3NEG);
	/*
	USAGE: Sets the shader program to a program already compiled
	ARGUMENTS:
	OUTPUT: ---
	*/
	void SetShaderProgram(String a_sShaderName = "Original", vector3 a_v3Tint = DEFAULT_V3NEG);
	/*
	...
	*/
	...
	OUTPUT: ---
	*/
	void SetGroupShaderByName(String a_sProgramName = "Original", String a_sGroupName = "ALL", vector3 a_v3Tint = DEFAULT_V3NEG);
	/*
	USAGE: Change the shader program of a group finding it by index
	ARGUMENTS:
	OUTPUT: ---
	*/
	void SetGroupShaderByNumber(String a_sProgramName = "Original", int nGroup = -1, vector3 a_v3Tint = DEFAULT_V3NEG);
	/*
	...
	*/
	...
	/*
	USAGE: Asks the instance if its already OUT_DONE instantiated
	ARGUMENTS: ---
	OUTPUT:
	*/
	...
	*/
	...
	ARGUMENTS:
	- int a_nOption = BTO_DISPLAY::BD_NONE -> Display options BD_NONE | BD_BO | BD_OB | BD_AB
	- String a_sInstanceName = "ALL" -> Instance to apply to
	- int a_nIndex = -2 -> Group index -1 will affect all groups, less than that will affect none
	OUTPUT: ---
	*/
	void SetVisibleBO(int a_nOption = BTO_DISPLAY::BD_NONE, int a_nGroupIndex = -2);
	/*
...
EXPIMP_TEMPLATE template class SimplexDLL std::vector<InstanceClass>;
EXPIMP_TEMPLATE template class SimplexDLL std::vector<InstanceClass*>;
