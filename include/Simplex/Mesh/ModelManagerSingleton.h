...
#include <string>
#include "Simplex\Mesh\InstanceClass.h"

namespace Simplex
{

class SimplexDLL ModelManagerSingleton
{
	//Member variables
...
public:
	...
	*/
	...
	/*
	USAGE: Checks if the instance in OUT_DONE animating
	ARGUMENTS:
	OUTPUT:
	*/
	...
	*/
	...
	OUTPUT: ---
	*/
	BTO_OUTPUT LoadLevel(String a_sFileName);
	/*
	...
	*/
	...
	/*
	USAGE: Saves the model as a FORMAT_ATO do not add the extension unless it's an absolute route
	ARGUMENTS:
	OUTPUT:
	*/
	BTO_OUTPUT SaveATO(String a_sFileName, bool a_bAbsoluteRoute, String a_sInstance);
	/*
	USAGE: Saves the model as a BTO do not add the extension unless it's an absolute route
	ARGUMENTS:
	OUTPUT:
	*/
	BTO_OUTPUT SaveBTO(String a_sFileName, bool a_bAbsoluteRoute, String a_sInstance);
	/*
