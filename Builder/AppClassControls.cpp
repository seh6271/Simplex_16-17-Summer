...
#pragma endregion
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Num0))
		m_pModel1->SetStateNext(0);
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Num1))
		m_pModel1->SetStateNext(1);
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Num2))
		m_pModel1->SetStateNext(2);
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Num3))
		m_pModel1->SetStateNext(3);
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Num4))
		m_pModel1->SetStateNext(4);
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Num5))
		m_pModel1->SetStateNext(5);
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Num6))
		m_pModel1->SetStateNext(6);
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Num7))
		m_pModel1->SetStateNext(7);
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Num8))
		m_pModel1->SetStateNext(8);
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Num9))
		m_pModel1->SetStateNext(9);
