...
void CameraManager::SetPositionTargetAndView(vector3 a_v3Position, vector3 a_v3Target, vector3 a_v3Upward, int a_nIndex)
{
	if (static_cast<uint>(a_nIndex) <= m_uCameraCount)
	{
		return m_lCamera[a_nIndex]->SetPositionTargetAndView(a_v3Position, a_v3Target, a_v3Upward);
	}
	return m_lCamera[m_uActiveCamera]->SetPositionTargetAndView(a_v3Position, a_v3Target, a_v3Upward);
}
